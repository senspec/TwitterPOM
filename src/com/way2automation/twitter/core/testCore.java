...
public class testCore {
	...
	public static void init() throws IOException{
		...
		if(driver == null){
			...
			FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\way2automation\\twitter\\config\\config.properties");
			config.load(fis);
			...
			//load the Excel file
			excel = new excel_reader(System.getProperty("user.dir")+"\\src\\com\\way2automation\\twitter\\testdata\\testdata.xlsx");
